...
/**
 * swap_ints -  a functio to swap two integers in an array.
...
/**
 * lomuto_partition - Order a subset of an integer array as per
 *                    the lomuto partition scheme using last element as pivot
 * @array: The array of integers to order
 * @size: The array size
 * @left: The first index of the subset to order.
 * @right: The last index of the subset to order.
 *
 * Return: The final partition index result
 */
int lomuto_partition(int *array, size_t size, int left, int right)
{
